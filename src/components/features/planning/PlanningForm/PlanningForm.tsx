...
export const PlanningForm = <T extends TPlanning | Omit<TPlanning, "id">>({
	...
	const onPortionsChange = useOnDishPortionsChange(setPlanningFormData);
	...
	const planningRows = usePlanningRows(planningFormData, onPortionsChange, onRemoveDish, onRemoveMeal);
